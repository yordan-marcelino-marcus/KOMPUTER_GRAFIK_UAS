...
Demo: [https://yordan-marcelino-marcus-img-cropper.onrender.com](https://fumui-img-cropper.onrender.com)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/yordan-marcelino-marcus/py-img-cropper.git
   ```
